<aside class="main-sidebar hidden-print">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/authors*') ? 'active' : '' }}"><a href="{{ url('/admin/authors') }}"><i class="fa fa-dashboard"></i><span>Authors</span></a></li>
            ...
            <li class="{{ Request::is('admin/sponsor*') ? 'active' : '' }}"><a href="{{ url('/admin/sponsor') }}"><i class="fa fa-dashboard"></i><span>Sponsor</span></a></li>
        </ul>
    </section>
</aside>